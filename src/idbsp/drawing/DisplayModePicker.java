...
public class DisplayModePicker {
	...
	public DisplayMode pickLargest() {
		List<DisplayMode> picks = Arrays.asList(device.getDisplayModes());
		
		if (picks.isEmpty()) {
			return default_mode;
		}

		AreaComparator wc = new AreaComparator();
	...
	/**
	 * Return offsets to center rasters too oddly shaped to fit entirely into a
	 * standard display mode (unfortunately, this means most stuff > 640 x 400),
	...
	class AreaComparator implements Comparator<DisplayMode> {

		@Override
		public int compare(DisplayMode arg0, DisplayMode arg1) {
			long area0 = arg0.getWidth() * arg0.getHeight();
			long area1 = arg1.getWidth() * arg1.getHeight();
			return Long.compare(area0, area1);
		}
